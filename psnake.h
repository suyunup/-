...
class SnakeGame{
  ...
  int stage=1;
  bool started = true;
  double total_playtime=0; //attribute에 추가
  bool stage_clear;
...
char after_game10[42] ="  00000  000000  000000  00  00  00    00";
  ...
  // 00000000   0000   000     000  000000     00000  00      000000   0000   000000
  // 00        00  00  0 00   00 0  00        00      00      00      00  00  00   00
  // 00  0000  00  00  0  0   0  0  000000   00       00      000000  00  00  000000
  // 00   00   000000  0   0 0   0  00        00      00      00      000000  00   00
  // 00000000  00  00  00  000   0  000000     00000  000000  000000  00  00  00    00
  ...
  Point search_output(int row, int col, Point output_gate, int *pre);
